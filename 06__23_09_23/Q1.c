...
Declare a structure ITEM having data members item_id, item_profit, item_weight and
profit_weight_ratio.take the input by user defined methodand Apply heap sort technique to sort the items in non-increasing order,
